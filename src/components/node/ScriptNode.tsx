...
const ScriptNodeComponent = ({
  ...
  return (
    <div className="shadow-lg rounded-2xl bg-[#1e1e1e] border border-gray-800 min-w-[300px] overflow-visible transition-all hover:shadow-xl hover:scale-[1.02] group">
      {/* Header */}
      <div className="bg-[#2d2d2d] px-4 py-3 flex items-center justify-between border-b border-gray-800 rounded-t-2xl">
        ...
        <div className="flex gap-1">
          <button
            ...
            className="nodrag text-gray-500 hover:text-white p-1 transition-colors"
          >
            <MdEdit />
          </button>
          <button
      ...
      <div className="p-0">
        {/* Code Preview */}
        <div className="bg-[#1e1e1e] p-5 text-xs font-mono text-gray-300 relative overflow-hidden group-hover:bg-[#252525] transition-colors">
        ...
        {/* Execution Paths */}
        <div className="p-4 bg-[#252525] flex flex-col gap-3">
          {/* Success Path */}
          <div className="relative">
            ...
            <Handle
              ...
              className="w-3 h-3 bg-emerald-500 border-2 border-[#252525] !-right-1.5 hover:scale-125 transition-transform"
            />
          </div>
          ...
          <div className="relative">
            ...
            <Handle
              ...
              id="error"
              isConnectable={isConnectable}
              className="w-3 h-3 bg-rose-500 border-2 border-[#252525] !-right-1.5 hover:scale-125 transition-transform"
            />
          </div>
        </div>
      </div>
      ...
      <Handle
        ...
        isConnectable={isConnectable}
        className="w-3 h-3 bg-gray-600 border-2 border-[#1e1e1e] !-left-1.5 hover:bg-cyan-400 transition-colors"
      />
    </div>
  );
};
