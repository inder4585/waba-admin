...
// Implementing simple Tabs since they are missing in ui/tabs.tsx or I can implement them.
// Actually, I'll check if tabs works or if I need to implement it. 
// I'll check src/components/ui/tabs.tsx. It was NOT in the list.
// So I will implement a custom Tabs component or just use simple state for tabs in this page to save time/complexity.
// I'll use simple state for tabs.
